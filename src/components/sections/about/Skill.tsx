...
import { SiTypescript, SiNextdotjs, SiFlutter, SiSupabase, SiPrisma } from "react-icons/si";
const Skill = () => {
  return (
    <div>
      <section className=" border-2 border-white rounded-lg p-2 pb-10">
        <header>
          <Headline title="言語 | フレームワーク|ツール" size="m" />
        </header>
        <article className="flex flex-col">
          <ul className="flex-1 md:flex flex-row  gap-2">
            <div className="flex flex-col gap-2 mt-2">
              ...
              <li className="flex flex-row ">
                <Language language="TypeScript" level={1} icon={<SiTypescript />} />
              </li>
              <li className="flex flex-row">
